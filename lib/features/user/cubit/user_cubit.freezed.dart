...
abstract class $UserStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({UserStatus userStatus, String? errorMessage});
}
...
class _$UserStateImpl implements _UserState {
  const _$UserStateImpl({required this.userStatus, this.errorMessage});
  ...
  @override
  String toString() {
    return 'UserState(userStatus: $userStatus, errorMessage: $errorMessage)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, userStatus, errorMessage);
